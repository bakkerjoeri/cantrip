function scr_card_definition_third_eye_opens() {
	var definition = {
		name: "third_eye_opens",
		title: "third eye opens",
		cost: 0,
		text: "For 3 turns, your opponent's hand is visible to you.",
		effect: do_third_eye_opens_effect,
	};
